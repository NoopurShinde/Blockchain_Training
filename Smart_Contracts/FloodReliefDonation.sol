...
contract FloodReliefDonation {
   ...
   // STORAGE VARIABLES
    ...
    function getContributorinfo(uint _id) public view returns(uint ID, string memory stateDOnated, uint Amt){
    ...
    function chkspendings(string memory _state, uint _requiredAmt) public returns(bool){
        require(statecontributionst[_state]>=_requiredAmt,"Funds not used in a proper way");
    }
